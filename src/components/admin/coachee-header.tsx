...
export function CoacheeHeader({ coachee, onEditKpis, onAssignModule, onSendMessage, onGenerateReport }: CoacheeHeaderProps) {
          ...
          {menuOpen && (
            <>
              ...
              <div className="absolute right-0 top-full mt-1 z-20 bg-white border border-gray-200 rounded-lg shadow-lg py-1 w-52">
                <button
                  onClick={() => { setMenuOpen(false); onEditKpis?.(); }}
                ...
                <button
                  onClick={() => { setMenuOpen(false); onAssignModule?.(); }}
                  className="flex items-center gap-2 w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
                >
                ...
                <button
                  onClick={() => { setMenuOpen(false); onSendMessage?.(); }}
                  className="flex items-center gap-2 w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
                >
                ...
                <button
                  onClick={() => { setMenuOpen(false); onGenerateReport?.(); }}
                  className="flex items-center gap-2 w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-50"
                >
