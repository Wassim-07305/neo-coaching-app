      ...
      <nav className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex h-16 sm:h-20 items-center justify-between">
          ...
          <div className="hidden sm:flex items-center gap-6">
            ...
            <Link href="/intervenants" className="text-sm text-gray-300 hover:text-white transition-colors">
              Intervenants
            </Link>
        ...
        {mobileOpen && (
          <div className="sm:hidden pb-4 border-t border-white/10 mt-1">
            <div className="flex flex-col gap-3 pt-4">
              <Link href="/#services" onClick={() => setMobileOpen(false)} className="px-5 py-2 text-sm text-gray-300 hover:text-white transition-colors">
                Services
              </Link>
              <Link href="/#tarifs" onClick={() => setMobileOpen(false)} className="px-5 py-2 text-sm text-gray-300 hover:text-white transition-colors">
                Tarifs
              </Link>
              <Link href="/#faq" onClick={() => setMobileOpen(false)} className="px-5 py-2 text-sm text-gray-300 hover:text-white transition-colors">
                FAQ
              </Link>
              <Link href="/intervenants" onClick={() => setMobileOpen(false)} className="px-5 py-2 text-sm text-gray-300 hover:text-white transition-colors">
                Intervenants
              </Link>
              <Link href="/blog" onClick={() => setMobileOpen(false)} className="px-5 py-2 text-sm text-gray-300 hover:text-white transition-colors">
                Blog
              </Link>
              <Link
                href="/connexion"
