...
// ---------- Annotations / Notes privees ----------
export interface MockAnnotation {
  id: string;
  coachee_id: string;
  content: string;
  created_at: string;
  tag?: "priorite" | "suivi_special" | "en_pause" | "general";
}

export const mockAnnotations: MockAnnotation[] = [
  {
    id: "ann-1",
    coachee_id: "coach-1",
    content: "Marie progresse tres bien. Envisager passage au module Prise de parole des la fin du module Confiance.",
  ...
  },
  {
    id: "ann-2",
    coachee_id: "coach-2",
    content: "Pierre montre des signes de decrochage. Planifier un appel de suivi rapidement. Voir si son manager peut l'encourager.",
  ...
  },
  {
    id: "ann-3",
    coachee_id: "coach-2",
    content: "Appel effectue le 21/02. Pierre a des difficultes personnelles. Mettre en pause temporairement si besoin.",
  ...
  },
  {
    id: "ann-4",
    coachee_id: "coach-8",
    content: "Isabelle est une coachee exemplaire. Lui proposer de devenir ambassadrice du programme.",
  ...
  },
  {
    id: "ann-5",
    coachee_id: "coach-10",
    content: "Emilie ne repond plus aux emails depuis aout. Dernier essai de contact avant archivage.",
  ...
  },
  {
    id: "ann-6",
    coachee_id: "coach-5",
    content: "Camille est tres motivee, excellente dynamique. A recommander pour le coaching individuel aussi.",
