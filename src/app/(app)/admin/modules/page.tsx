...
import { useModules } from "@/lib/supabase/hooks";
import { adaptModules } from "@/lib/supabase/adapters";
import { mockModules } from "@/lib/mock-data";
import type { MockModule } from "@/lib/mock-data";

export default function ModulesPage() {
  const { data: supaModules, loading } = useModules();
  // Use Supabase modules if available, otherwise mock
  const modules = supaModules ? adaptModules(supaModules) : mockModules;
